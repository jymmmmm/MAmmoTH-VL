...
class LazySupervisedDataset(Dataset):
    ...
    def _get_item(self, i) -> Dict[str, torch.Tensor]:
        ...
        # print(data_dict)
        # print("Unique values:", torch.unique(data_dict["image"][0][0]))
        # print("Min value:", torch.min(data_dict["image"][0][0]))
        # print("Max value:", torch.max(data_dict["image"][0][0]))
        # print("Mean value:", torch.mean(data_dict["image"][0][0]))
